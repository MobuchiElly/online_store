...
const EmailSuccessModal = ({closeModal}) => {
  return (
        ...
        <div className='bg-white relative flex flex-col items-center space-y-4 px-8 py-6 text-slate-800 rounded-xl md:w-[50%] lg:w-[40%]'>
            ...
            <div className="space-y-2">
              <div className="flex justify-center">
                <Image src="/assets/images/green-check.svg" height={50} width={55}/>
              </div>
              <h1 className="text-gray-800 text-[26px] font-[600]">You're on the list!</h1>
            </div>
            <p className="text-center text-[16px] font-[500] text-gray-700">Thank you for signing up to our newsletter. You'll receive discounts, coupons, and other offers right in your inbox.</p>
